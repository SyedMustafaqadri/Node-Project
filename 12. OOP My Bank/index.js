...
// for customer name
let name = myBank.customer.find((cus) => cus.accNumber == account?.accNumber);
if (!account) {
...
async function bankService(bank) {
    ...
    if (service.service == "Deposit") {
        ...
        console.log(`Dear ${chalk.blueBright.bold(name?.firstName, name?.lastName)}, your balance is ${chalk.greenBright.bold("$" + account?.balance)}`);
